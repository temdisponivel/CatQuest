 ...
 * defesa, ataque, vida, chanse de dano cr�tico, etc.
 * 
 * @author matheus
 *
 */
...
{
	/**
	 * Classe que representa uma c�lular para calcular o A* e guardar valores de
	 * custo de movimenta��o.
	 * 
	 * @author matheus
	 *
	 */
	...
	/**
	 * Enumerador para as {@link Animation anima��es} dos {@link Personagem
	 * personagens}.
	 * 
	 * @author matheus
	 *
	 ...
	 *         defesa s�o subtra�dos do ataque inflingido a este ator.
	 */
	 ...
	 * caminho esteja vazio ou nulo, n�o faz nada. Ele vai se movimentar da
	 * posi��o atual, at� a pr�xima da pilha de caminho segundo este deltatime.
	 * 
	 * @param deltaTime
	 *            Deltatime do frame para realizar a movimenta��o.
	 * @return True se alcan�ou o pr�ximo ponto do caminho, falso caso contr�rio
	 *         e quando n�o h� caminho.
	 */
	 ...
	 * 
	 * @param dano
	 *            Pontos de dano a inflingir. Repare que destes pontos ser�o
	 *            subtra�dos a defesa do ator.
	 */
	...
	/**
	 * Fun��o que retorna um caminho at� o {@link #_destino destino}. Calculado
	 * com A*.
	 * 
	 * @return {@link LinkedList<Vector2> Fila} da posi��o atual at� o destino.
	 *         Ou nulo caso n�o haja caminho. Este caminho tamb�m � defino em
	 *         {@link #_caminho}, mas quando n�o h� caminho {@link #_caminho}
	 *         fica limpa.
	 */
	protected LinkedList<Vector2> GetCaminho()
	{
		...
		while (!listaAberta.isEmpty())
		{
			...
			for (int i = 0; i < adjacentes.size(); i++)
			{
				...
				// se j� cont�m, valida a distancia entre o adjacente e o pai
				// dele e verifica se h� um melhor caminho
				else
				{
...
/**
	 * Faz a movimenta��o do {@link Personagem personagem}. S� movimenta em
	 * campo diferente de n�o pass�vel. Ou seja, nunca existe colis�o
	 * movimentando por aqui. Caso n�o haja mais posi��o v�lida na dire��o
	 * informada, nada acontece.
	 * 
	 * @param direcao
	 *            {@link Direcoes Dire��o} para movimentar.
	 * @param delta
	 *            Coeficiente para a agilidade. Valor utilizado para multiplicar
	 *            a agilidade, o que define o quanto ele vai andar na dire��o
	 *            informada.
	 * @param colidi
	 *            True caso seja para andar mesmo que o campo n�o seja v�lido. O
	 *            que resultar� numa colis�o.
	 * @return {@link Vector2 Posi��o} para o qual se moveu ou nulo caso n�o tenha se movido. � poss�vel que ele n�o chegue na posi��o neste frame.
	...
	/**
	 * Retorna a {@link Vector2 Posi��o} na {@link Direcoes dire��o} informada.
	 * 
	 * @param direcao
	 *            Dire��o para lhar.
	 * @return {@link Vector2 Posi��o} na dire��o informada. Nulo caso seja uma
	 *         {@link Direcoes dire��o} inv�lida, ou centro.
	 */
	...
	/**
	 * Retorna o campo de vis�o do personagem.
	 * 
	 * @return Um float representando o raio de vis�o deste {@link Personagem
	 *         personagem}.
	 */
	 ...
	 *         campo de vis�o deste e n�o haja nada colid�vel entre os dois
	 *         objetos.
	 * @param outro
	...
	/**
	 * Fun��o para quando o personagem morrer. Ou seja, quando seu
	 * {@link #_vida =< 0}.
	 */
